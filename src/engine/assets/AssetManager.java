...
public class AssetManager
{
	...
	private ArrayList<Material> processMaterials(PointerBuffer aiMaterials, int numMaterials, Texture texture, ShaderProgram shaderProgram)
	{
	...
	private Renderable3D processMesh(AIMesh mesh, ArrayList<Material> materials, ShaderProgram shaderProgram, String filename)
	{
		// Vertices
